...
for i in file_path:
    ...
    if unknown_byte_file != []:
        ...
        while True:
            if (batch_header == ("batch_id") and
                timestamp_header == ("timestamp") and
                reading1_header == ("reading1") and
                reading2_header == ("reading2") and
                reading3_header == ("reading3") and
                    reading4_header == ("reading4")):
                ...
                break
        while True:
            if (reading5_header == ("reading5") and
               reading6_header == ("reading6") and
               reading7_header == ("reading7") and
               reading8_header == ("reading8") and
               reading9_header == ("reading9") and
               reading10_header == ("reading10")):
                total_headers.append("correct")
                break
            else:
                unused_copys.append("wrong")
